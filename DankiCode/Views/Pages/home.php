	...
	<section class="main-feed">
		...
		<div class="feed">	
			...
			<div class="feed-wraper">
				...
				<div class="feed-form">
					<form method="post">
						<textarea name="post_cotent" placeholder="No que você está pensando?"></textarea>
			...
			$retrivePosts = \DankiCode\Models\homeModel::retriveFriendsPosts();
			...
			<div class="feed-single-post">
				...
				<div class="feed-single-post-author">
					...
					<?php }else if(!isset($value['me'])){ ?>
						...
						<img src="<?php echo INCLUDE_PATH_STATIC ?>uploads/<?php echo $value['img'] ?>" />
					...
					<?php }else if(isset($value['me'])){ ?>
						...
						<img src="<?php echo INCLUDE_PATH_STATIC ?>uploads/<?php echo $_SESSION['img'] ?>" />
		  ...
		  <?php }	 ?>
			...
			<div class="friends-request-feed">
				...
				<?php foreach(\DankiCode\Models\UsuariosModel::listarAmizadesPendentes() as $key=>$value){
